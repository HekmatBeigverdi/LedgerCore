...
namespace LedgerCore.Migrations
{
    ...
    [Migration("20260406145739_AddWarehouseTransferInventoryOperation")]
    partial class AddWarehouseTransferInventoryOperation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.PaymentAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PaymentId", "PurchaseInvoiceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.PurchaseReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.ReceiptAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiptId", "SalesInvoiceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.SalesReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Inventory.WarehouseTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Inventory.WarehouseTransferLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WarehouseTransferId", "LineNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("LedgerCore.Core.Models.Documents.PurchaseReturn", "PurchaseReturn")
                        .WithMany("Lines")
                    ...
                    b.HasOne("LedgerCore.Core.Models.Documents.SalesReturn", "SalesReturn")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.PaymentAllocation", b =>
                {
                    b.HasOne("LedgerCore.Core.Models.Documents.Payment", "Payment")
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Documents.ReceiptAllocation", b =>
                {
                    b.HasOne("LedgerCore.Core.Models.Documents.Receipt", "Receipt")
                        .WithMany("Allocations")
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Inventory.WarehouseTransfer", b =>
                {
                    ...
                    b.HasOne("LedgerCore.Core.Models.Inventory.Warehouse", "FromWarehouse")
                        .WithMany()
                        .HasForeignKey("FromWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LedgerCore.Core.Models.Inventory.Warehouse", "ToWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("LedgerCore.Core.Models.Inventory.WarehouseTransferLine", b =>
                {
                    ...
                    b.HasOne("LedgerCore.Core.Models.Inventory.WarehouseTransfer", "WarehouseTransfer")
                        .WithMany("Lines")
